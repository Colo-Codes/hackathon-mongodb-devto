                            ...
                            return (
                                <li key={number} className=''>
                                    <button
                                        ...
                                        className={`py-2 px-4 leading-tight bg-white border border-gray-200 text-indigo-700 border-r-0 ml-0 rounded hover:bg-indigo-500 hover:text-white cursor-pointer ${number === currentPage && 'bg-slate-600'}`}>
                                        <span>{number}</span>
                                    </button>
                                </li>
                            );
