...
const Footer = () => {
    return (
        <footer className="bg-gray-100 bottom-0 w-full">
            <div className="container mx-auto px-6 py-3 flex justify-between items-center">
                ...
                <p className="text-gray-300">This web application was created as part of the MongoDB & DEV.to hackathon during the first week of 2022.</p>
