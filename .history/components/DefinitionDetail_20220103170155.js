    ...
    return (
        ...
        <div className="max-w-2xl mx-auto mt-5 md:mt-0 ">
            ...
            <div className="flex items-center mt-6">
                <button onClick={addToFavourites} value={definition} className="px-8 py-2 bg-indigo-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500">
