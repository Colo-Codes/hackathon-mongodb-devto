                ...
                <div className="relative mt-6 max-w-lg mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className='flex'>
                        <input
                            ...
                            value={searchTerm}
                        />
                        <button type="submit" className="py-2 px-4 leading-tight text-white border border-gray-200border-r-0 rounded hover:text-white mr-4 bg-indigo-700 hover:bg-indigo-500">Search</button>
                    </form>
