                ...
                <div className="relative mt-6 max-w-lg mx-auto">
                    ...
                    <form onSubmit={handleSubmit}>
                        <input
                            ...
                            value={searchTerm}
                        />
                        <button type="submit" className="py-2 px-4 leading-tight bg-white border border-gray-200border-r-0 rounded hover:text-white mr-4 text-indigo-700 hover:bg-indigo-500">Search</button>
                    </form>
