                            ...
                            return (
                                <li key={number} className=''>
                                    <a
                                        ...
                                        className='w-xl h-10 leading-tight bg-white border border-gray-200 text-indigo-700 border-r-0 ml-0 rounded-l hover:bg-indigo-500 hover:text-white cursor-pointer'>
                                        <span>{number}</span>
                                    </a>
                                </li>
                            );
                        ...
                        if (i === currentPage + 5) {
                            return (
                                <li key={number} className='mx-2'>
                                    <span className='px-4 py-2 leading-tight bg-white border border-gray-200 text-indigo-700 border-r-0 ml-0 rounded-l hover:bg-indigo-500 hover:text-white cursor-pointer'>
                                        ...
                                    </span>
                                </li>
                            );
