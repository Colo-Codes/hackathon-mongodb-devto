        ...
        <Link href={`/definitions/${definition._id}`}>
            <div className="w-full mx-auto rounded-md shadow-md overflow-hidden cursor-pointer hover:shadow-2xl transition">
                <div className="px-5 py-3">
                    <h3 className="text-indigo-700 font-extrabold uppercase"><span>{definition.score}</span><ChevronDoubleRightIcon className="w-4 h-4 inline-block mr-2" />{parse(definition.title)}</h3>
                    <hr></hr>
