...
const DefinitionDetail = ({ definition }) => {
    return (
        <div className="md:flex md:items-center">
            ...
            <div className="w-full md:w-1/2 relative self-center">
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">Definition extracted from MDN Web Docs</p>
