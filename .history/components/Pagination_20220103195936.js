                            ...
                            return (
                                <li key={number} className=''>
                                    <a
                                        ...
                                        className='w-4 h-10 leading-tight bg-white border border-gray-200 text-indigo-700 border-r-0 ml-0 rounded-l hover:bg-indigo-500 hover:text-white cursor-pointer'>
                                        <span>{number}</span>
                                    </a>
                                </li>
                            );
