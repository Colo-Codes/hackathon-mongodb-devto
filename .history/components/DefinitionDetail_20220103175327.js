            ...
            <div className="flex items-center mt-6">
                {
                    !favourites.includes(definition.title)
                        ...
                        :
                        <button onClick={removeFromFavourites} value={definition.title} className="px-8 py-2 bg-orange-600 text-white text-sm font-medium rounded hover:bg-indigo-500 focus:outline-none focus:bg-indigo-500">
