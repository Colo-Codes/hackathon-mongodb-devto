            ...
            <header>
                ...
                >
                    <div className="flex flex-col sm:flex-row">
                        ...
                        <a
                            className="font-medium text-gray-500 hover:text-gray-900 mt-3 hover:underline sm:mx-3 sm:mt-0"
                            href="#"
                        >
                            About
                        </a>
                ...
                <div className="relative mt-6 max-w-lg mx-auto">
                    ...
                    {autoComplete.length > 0 && (
                        < ul className='absolute inset-x-0 top-full bg-indigo-200 border border-green-500 rounded-md z-20'>
