                ...
                <Container>
                    <div className="relative bg-white overflow-hidden">
                                        ...
                                        <div className="relative pt-6 w-full">
                                            ...
                                            <nav>
                                                <div className="flex flex-wrap sm:h-10 justify-around md:ml-10 md:pr-4 md:space-x-8">
                                                    ...
                                                    <a href="#" className="mx-2 font-medium text-gray-500 hover:text-gray-900"><ArrowCircleRightIcon className="w-4 h-4 inline mr-1 mb-1" />MongoDB Tutorial</a>
                                                    <a href="#" className="mx-2 font-medium text-indigo-600 hover:text-indigo-500"><ArrowCircleRightIcon className="w-4 h-4 inline mr-1 mb-1" />Follow me on Twitter</a>
                                                </div>
                                            </nav>
                                        </div>
                                    </div>
                        ...
                        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                            <img className="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full" src="images/about.jpg" alt="About the project" />
                        </div>
                    </div>
                </Container>
                <Footer />
