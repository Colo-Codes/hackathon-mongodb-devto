                                ...
                                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                                    <div className="sm:text-center lg:text-left">
                                        ...
                                        <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                                            <hr></hr>
                                            <nav>
                                                <div className="flex flex-wrap sm:h-10 items-center justify-between md:block md:ml-10 md:pr-4 md:space-x-8">
                                                    ...
                                                    <a href="#" className="mx-2 font-medium text-indigo-600 hover:text-indigo-500"><ArrowCircleRightIcon className="w-4 h-4 inline mr-1 mb-1" />About Damian Demasi</a>
                                                </div>
                                            </nav>
                                        </div>
                                    </div>
