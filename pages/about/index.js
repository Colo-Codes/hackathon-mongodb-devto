                                    ...
                                    <div className="sm:text-center lg:text-left">
                                        ...
                                        <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-between">
                                            <div className="rounded-md shadow">
                                                <a href="https://dev.to/devteam/announcing-the-mongodb-atlas-hackathon-on-dev-4b6m" target="_blank" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 md:py-4 md:text-lg md:px-10">
                                                    Hackathon
                                                </a>
                                            </div>
                                        ...
                                        <div className="relative pt-6 w-full">
                                            ...
                                            <nav>
                                                <div className="flex flex-wrap sm:h-10 justify-around md:ml-10 md:pr-4 md:space-x-8">
                                                    <a href="https://docs.mongodb.com/" target="_blank" className="mx-2 font-medium text-gray-500 hover:text-gray-900"><ArrowCircleRightIcon className="w-4 h-4 inline mr-1 mb-1" />MongoDB Docs</a>
